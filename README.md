...
📊 <!-- TOTAL_START -->46,851 total interactions · updated 2026-06-09<!-- TOTAL_END -->
...
**custom-made**
- 🐞 plant-bug-interactive-map [↗](https://hansenvalueinvesting.github.io/plant-bug-interactive-map/) | arthropod × hostplant relationship visualizer. built for [Earthwise Aware](https://www.earthwiseaware.org/). | 📊 <!-- USES:plant-bug-interactive-map -->209 interactions<!-- /USES:plant-bug-interactive-map -->

**economics + finance**
- 📡 newsfeed [↗](https://hansenvalueinvesting.github.io/newsfeed/) | live 24hr news aggregator. | 📊 <!-- USES:newsfeed -->46,421 interactions<!-- /USES:newsfeed -->
