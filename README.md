...
📊 <!-- TOTAL_START -->58,670 total interactions · updated 2026-07-04<!-- TOTAL_END -->
(across tracked projects)

**general**
- ⏱️ focus timer [↗](https://hansenvalueinvesting.github.io/focus-timer/) | session-based focus tracker with stats. | 📊 <!-- USES:focus-timer -->246 interactions<!-- /USES:focus-timer --> 

**economics + finance**
- 📡 newsfeed [↗](https://hansenvalueinvesting.github.io/newsfeed/) | live 24hr news aggregator. | 📊 <!-- USES:newsfeed -->58,105 interactions<!-- /USES:newsfeed -->
