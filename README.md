...
📊 <!-- TOTAL_START -->57,710 total interactions · updated 2026-06-29<!-- TOTAL_END -->
...
**economics + finance**
- 📡 newsfeed [↗](https://hansenvalueinvesting.github.io/newsfeed/) | live 24hr news aggregator. | 📊 <!-- USES:newsfeed -->57,183 interactions<!-- /USES:newsfeed -->
...
**custom builds**
- 🐞 plant-bug-interactive-map [↗](https://hansenvalueinvesting.github.io/plant-bug-interactive-map/) | arthropod × hostplant relationship visualizer. built for [Earthwise Aware](https://www.earthwiseaware.org/). | 📊 <!-- USES:plant-bug-interactive-map -->306 interactions<!-- /USES:plant-bug-interactive-map -->
